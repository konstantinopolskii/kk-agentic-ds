...
//#region sfc/pages/03-identity-hero-v2.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "metric-row" };
var _hoisted_2 = { class: "metric-row" };
var _hoisted_3 = { class: "metric-row" };
//#endregion
//#region sfc/pages/03-identity-hero-v2.vue
var _03_identity_hero_v2_default = /* @__PURE__ */ defineComponent({
	__name: "03-identity-hero-v2",
	setup(__props) {
		return (_ctx, _cache) => {
				...
				default: withCtx(() => [createVNode(unref(KBook), { id: "doc" }, {
					default: withCtx(() => [
						...
						createVNode(unref(KBookSection), { id: "founder" }, {
							default: withCtx(() => [
								_cache[2] || (_cache[2] = createElementVNode("h1", { class: "t-poster" }, "Founder", -1)),
...
//#endregion
export { _03_identity_hero_v2_default as default };
