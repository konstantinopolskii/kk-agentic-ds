...
//#endregion
//#region sfc/pages/14-newsfront-v2.vue
var _14_newsfront_v2_default = /* @__PURE__ */ defineComponent({
	__name: "14-newsfront-v2",
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(KApp), { view: "front" }, {
				default: withCtx(() => [createVNode(unref(KFront), null, {
					default: withCtx(() => [
						_cache[19] || (_cache[19] = createElementVNode("header", { class: "front__masthead" }, [createElementVNode("h1", { class: "t-poster" }, "The Specimen"), createElementVNode("p", { class: "t-micro t-muted" }, "Design's daily record · Friday, July 18, 2026 · Issue 214")], -1)),
						createVNode(unref(KCard), {
							...
							default: withCtx(() => [
								createVNode(unref(KFigure), { caption: "Proof sheet: Commissioner across the weight axis, for The Specimen" }, {
									default: withCtx(() => [..._cache[0] || (_cache[0] = [createElementVNode("div", {
										...
										createElementVNode("span", { style: { "font-weight": "200" } }, "A"),
										createElementVNode("span", { style: { "font-weight": "400" } }, "G"),
										createElementVNode("span", {
											class: "specimen--ink",
											style: { "font-weight": "700" }
										}, "Q"),
										createElementVNode("span", { style: { "font-weight": "900" } }, "R"),
										createElementVNode("span", { style: { "font-weight": "200" } }, "a"),
										createElementVNode("span", { style: { "font-weight": "400" } }, "g"),
										createElementVNode("span", { style: { "font-weight": "700" } }, "e"),
										createElementVNode("span", { style: { "font-weight": "900" } }, "&")
									], -1)])]),
									_: 1
								}),
								_cache[2] || (_cache[2] = createElementVNode("p", { class: "t-micro t-muted" }, "Tooling · Exclusive", -1)),
								_cache[3] || (_cache[3] = createElementVNode("div", { class: "card__heading" }, [createElementVNode("h2", { class: "t-display" }, "Rill ships an agent-readable component format"), createElementVNode("p", { class: "t-body" }, "Every component now exports as structured JSON next to the visual file, and three plugin makers say the bridge from design to code just lost weeks of glue work. The format lands in the stable channel Monday; the spec is open from day one.")], -1)),
								...
								createVNode(unref(KButton), { as: "span" }, {
									default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode("Read the story", -1)])]),
									_: 1
								})
							]),
							_: 1
						...
						createVNode(unref(KFrontRail), { title: "Latest" }, {
							default: withCtx(() => [
								...
								_cache[11] || (_cache[11] = createElementVNode("a", {
									class: "media",
									href: "#"
								...
								createVNode(unref(KCard), null, {
									default: withCtx(() => [
										...
										createVNode(unref(KFieldRow), { label: "Foundry deals, YTD" }, {
											default: withCtx(() => [..._cache[4] || (_cache[4] = [createTextVNode("14 ", -1), createElementVNode("span", { class: "t-caption--bold" }, "↑ 4", -1)])]),
											_: 1
										}),
										createVNode(unref(KFieldRow), { label: "Median design salary" }, {
											default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode("$118K ", -1), createElementVNode("span", { class: "t-caption--bold" }, "↑ 2%", -1)])]),
											_: 1
										}),
										createVNode(unref(KFieldRow), { label: "Open design roles" }, {
											default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("8 210 ", -1), createElementVNode("span", { class: "t-caption--bold" }, "↓ 6%", -1)])]),
											_: 1
										})
									]),
									_: 1
						...
						createVNode(unref(KFrontDesks), null, {
							default: withCtx(() => [
								createVNode(unref(KCard), {
									...
									default: withCtx(() => [
										_cache[13] || (_cache[13] = createElementVNode("p", { class: "t-micro t-muted" }, "Product", -1)),
										...
										createVNode(unref(KButton), { as: "span" }, {
											default: withCtx(() => [..._cache[12] || (_cache[12] = [createTextVNode("Open product", -1)])]),
											_: 1
										})
									]),
									_: 1
								...
								createVNode(unref(KCard), {
									...
									default: withCtx(() => [
										_cache[15] || (_cache[15] = createElementVNode("p", { class: "t-micro t-muted" }, "Craft", -1)),
										_cache[16] || (_cache[16] = createElementVNode("div", { class: "card__heading" }, [createElementVNode("h3", { class: "t-title" }, "Drawing a typeface for low vision took six months of testing"), createElementVNode("p", { class: "t-caption" }, "Every counter and stroke answered to readers, not to the designer's eye.")], -1)),
										createVNode(unref(KButton), { as: "span" }, {
											default: withCtx(() => [..._cache[14] || (_cache[14] = [createTextVNode("Open craft", -1)])]),
											_: 1
										})
									]),
									_: 1
								...
								createVNode(unref(KCard), {
									...
									default: withCtx(() => [
										_cache[18] || (_cache[18] = createElementVNode("p", { class: "t-micro t-muted" }, "Field notes", -1)),
										createVNode(unref(KCardHeading), {
										...
										createVNode(unref(KButton), { as: "span" }, {
											default: withCtx(() => [..._cache[17] || (_cache[17] = [createTextVNode("Open field notes", -1)])]),
											_: 1
										})
									]),
									_: 1
...
//#endregion
export { _14_newsfront_v2_default as default };
