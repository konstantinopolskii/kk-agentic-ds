...
//#region sfc/pages/12-studio-index-v2.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "book__section book__section--fill" };
//#endregion
//#region sfc/pages/12-studio-index-v2.vue
var _12_studio_index_v2_default = /* @__PURE__ */ defineComponent({
	__name: "12-studio-index-v2",
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(KApp), { view: "single" }, {
				default: withCtx(() => [createVNode(unref(KBook), { id: "doc" }, {
					default: withCtx(() => [createElementVNode("article", _hoisted_1, [createVNode(unref(KCard), { variant: "shout" }, {
						default: withCtx(() => [..._cache[0] || (_cache[0] = [createElementVNode("div", { class: "card__heading" }, [createElementVNode("h1", { class: "t-poster" }, "Buckwheat"), createElementVNode("p", { class: "t-title" }, "Digging out of the mess, one grain at a time. A two-person studio that ships tools for money and work, then keeps them alive for a decade.")], -1), createElementVNode("p", { class: "t-micro t-subtle" }, "Two people and a cat · 2014 to 2026 · both tools still shipping", -1)])]),
						_: 1
...
//#endregion
export { _12_studio_index_v2_default as default };
