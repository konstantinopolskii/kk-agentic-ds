...
/* Vue twin of 10-tzlvt-landing.html. Kit components where the emitted
   markup matches exactly; raw h() for bespoke variants with no component
   prop (book__section--fill) and for the two buttons, which the static
   page ships without a type attribute (KButton always stamps
   type="button", so it would diverge). Text nodes carrying an
   apostrophe use innerHTML — Vue's SSR text-escaping renders a literal
   apostrophe as &#39;, which the static page never does. */
export default {
  render() {
      ...
      h(KBook, { id: 'doc' }, () => [
        ...
        h(KBookSection, { id: 'free' }, () => [
          ...
          h(
            ...
            'Written about by Meduza, vc.ru, and Lifehacker.',
          ),
