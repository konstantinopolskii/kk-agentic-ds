...
/* Vue twin of 12-studio-index-v2.html. Same DOM, kit components where
   they exist, raw h() for the bespoke bits: book__section--fill has no
   component prop, and the poster card__heading (h1.t-poster + p.t-title)
   diverges from KCardHeading's h3.t-title shape. */
export default {
  render() {
      ...
      h(KBook, { id: 'doc' }, () => [
        h('article', { class: 'book__section book__section--fill' }, [
          h(KCard, { variant: 'shout' }, () => [
            ...
            h('p', { class: 't-micro t-subtle' }, 'Two people and a cat · 2014 to 2026 · both tools still shipping'),
          ]),
        ]),
