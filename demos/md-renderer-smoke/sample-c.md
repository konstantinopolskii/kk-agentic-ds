...
<div class="card">
  <div class="card__heading">
    ...
    <p class="t-caption">Authored as raw HTML inside a .md file.</p>
  </div>
  <p class="t-caption">Body paragraph inside the card. The kit's card CSS still applies. No renderer magic needed beyond passthrough.</p>
</div>
...
<div class="card card--shout">
  ...
  <p class="t-caption">Everything inside inverts against the kit's shout surface.</p>
</div>
